            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="add-role" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                            ...
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                         ...
                                         <tr id="changeTr_${i.id }">
                                            <td>${loop.count }</td>
                                            <td>${i.name }</td>
                                            <td>${i.description }</td>
                                            <td>
                                                <a href="<%=context+EnumUrlParam.UPDATE_ROLE.getEndpoint() %>?id=${i.id }"  class="btn btn-sm btn-primary">Sửa</a>
                                                <button id="deleteRole_${i.id }" onclick="deleteRole(${i.id})" class="btn btn-sm btn-danger">Xóa</button>
                                            </td>
                                        </tr>
                                         </c:forEach>
