			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form class="form-horizontal form-material" action="<%=context+EnumUrlParam.ADD_USER.getEndpoint() %>"
								method="post">
								<div class="form-group">
									...
									<div class="col-md-12">
										...
										<p style="color: red;" id="fisrtnametxt"></p>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										...
										<p style="color: red;" id="lastnametxt"></p>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										...
										<p style="color: red;" id="emailtxt"></p>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										...
										<p style="color: red;" id="passwordtxt"></p>
									</div>
								</div>
								<div class="form-group">
