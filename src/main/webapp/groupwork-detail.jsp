                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${chuaBatDau}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right m-t-15 text-megna">${daBatDau }%</h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-megna" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${daBatDau}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${hoanthanh}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <c:forEach var="i" items="${listnomal }">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5>${i.nameUser() }</h5> 
                                        <span class="mail-desc">${i.nameTask() }</span> 
                                        <span
                                            class="time">thời gian bắt đầu : ${i.startDate() }</span>
                                        <span
                                            class="time">thời gian kết thúc : ${i.endDate() }</span>
                                    </div>
                                </a>
                                </c:forEach>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <c:forEach var="i" items="${liststart }">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5>${i.nameUser() }</h5> 
                                        <span class="mail-desc">${i.nameTask() }</span> 
