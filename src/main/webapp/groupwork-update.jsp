            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<%=context+EnumUrlParam.UPDATE_PROJECT.getEndpoint() %>?id=${project.id() }" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" name="stars-time" value="${project.startTime() }"> </div>
                                </div>
                                <div class="form-group">
