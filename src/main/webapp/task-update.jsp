            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<%=context+EnumUrlParam.UPDATE_TASK.getEndpoint() %>?id=${task.id() }" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Dự án</label>
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="idProject">
                                            <c:forEach var="i" items="${listproject }">
                                               <c:if test="${i.id()==task.idProject() }">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" name="first" value="${task.startDate() }"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" name="last" value="${task.endDate() }"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">tiến độ công việc</label>
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="idStatus">
                                           <c:forEach var="i" items="${liststatus }">
                                              <c:if test="${i.id()== task.idStatus() }">
                                                <option selected value="${i.id() }">${i.name() }</option>
                                              </c:if>
                                              <c:if test="${i.id()!= task.idStatus() }">
                                                <option  value="${i.id() }">${i.name() }</option>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=context+EnumUrlParam.TASK.getEndpoint() %>" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
