            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<%=context+EnumUrlParam.ADD_ROLE.getEndpoint() %>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Mô tả" class="form-control form-control-line" name="desr"/>
                                      
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" id="formRoleAdd" class="btn btn-success">Add Role</button>
