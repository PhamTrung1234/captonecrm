                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h4 class="text-white">${users.nameUser }</h4>
	...
	<div class="row">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="white-box">
				<div class="col-in row">
					<div class="col-xs-12">
						<h3 class="counter text-right m-t-15 text-megna">${chuaHoanThanh }%</h3>
                    </div>
                    <div class="col-xs-12">
                            ...
                            <div class="message-center">
                                ...
                                <a href="#">
                                    <div class="mail-contnet">
                                        ...
                                        <span class="time">Bắt đầu: ${i.startDate() }</span>
                                        <span class="time">Kết thúc: ${i.endDate() }</span>
                                    </div>
                                </a> 
                                </c:forEach>
