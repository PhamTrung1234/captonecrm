            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=context+EnumUrlParam.ADD_TASK.getEndpoint() %>" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        <c:forEach var="i" items="${listtask }" varStatus="loop">
                                        <tr>
                                            <td>${loop.count }</td>
                                            <td>${i.nameTask() }</td>
                                            <td>${i.nameProject() }</td>
                                            ...
                                            <td>${i.nameStatus() }</td>
                                            <td>
                                                <a href="<%=context+EnumUrlParam.UPDATE_TASK.getEndpoint() %>?id=${i.id() }"   class="btn btn-sm btn-primary">Sửa</a>
                                                <button onclick="deletetask(${i.id()})" class="btn btn-sm btn-danger">Xóa</button>
