<%@page import="crm.entity.UserEntity"%>
<%@page import="crm.enumurl.EnumUrlParam"%>
<%@page import="crm.service.UserService"%>
...
<% UserEntity currenUser = (UserEntity)request.getAttribute("users"); %>
<%  int idRole = currenUser.getRole().getId();
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="<%=context+EnumUrlParam.USER.getEndpoint() %>" class="waves-effect"><i
							class="fa fa-user fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Thành viên</span></a></li>
					<li><a href="<%=context+EnumUrlParam.ROLE.getEndpoint() %>" class="waves-effect"><i
							class="fa fa-modx fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Quyền</span></a></li>
					<li><a href="<%=context+EnumUrlParam.PROJECT.getEndpoint() %>" class="waves-effect"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Dự án</span></a></li>
					<li><a href="<%=context+EnumUrlParam.TASK.getEndpoint() %>" class="waves-effect"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form class="form-horizontal form-material"
								action="<%=context+EnumUrlParam.UPDATE_USER.getEndpoint() %>?id=<%=currenUser.getId() %>" method="post">
								<div class="form-group">
									<label class="col-md-12">First Name</label>
									<div class="col-md-12">
										<input type="text" id="firstName"
											class="form-control form-control-line" name="firstName"
											value="<%= currenUser.getFirst_name()%>">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" id="lastName"
											class="form-control form-control-line" name="lastName"
											value="<%=currenUser.getLast_name()%>">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<button type="submit" id="addUser" class="btn btn-success">Update
											User</button>
										<a href="<%=context+EnumUrlParam.USER.getEndpoint() %>"
